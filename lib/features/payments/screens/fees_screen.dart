...
class _FeesScreenState extends State<FeesScreen>
  ...
  Widget build(BuildContext context) {
    final totalCollected =
        _fees.fold(0.0, (s, f) => s + f.paidAmount);

    final totalPending =
        _fees.fold(0.0, (s, f) => s + f.pendingAmount);
...
class _FeeTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final progress = fee.totalFee > 0
        ? (fee.paidAmount / fee.totalFee)
            .clamp(0.0, 1.0)
        : 0.0;

    final statusColor =
        AppColors.statusColor(fee.status);
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                      'Due: ₹${fee.pendingAmount.toStringAsFixed(0)}'),
                  Text(
